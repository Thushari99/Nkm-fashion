        ...
        const fetchBrandDetails = async () => {
            ...
            try {
                ...
                if (response.data.logo) {
                    setLogoPreview(response.data.logo); // Show the current logo in the preview
                }
            } catch (error) {
    ...
    return (
        <div className="background-white absolute top-[80px] left-[18%] w-[82%] h-[800px] p-5">
            <div className="flex justify-between items-center">
                ...
                <div>
                    <Link className='px-4 py-1.5 border border-[#35AF87] text-[#35AF87] rounded-md transition-colors duration-300 hover:bg-[#35AF87] hover:text-white' to={'/viewBrands'}>Back</Link>
                </div>
            </div>
            {loading && (
            ...
            <div className="bg-white mt-[20px] w-[630px] h-[600px] rounded-2xl px-8 shadow-md">
                <div className="flex min-h-full flex-1 flex-col px-2 py-12 lg:px-8">
                    <form onSubmit={handleSubmit} encType="multipart/form-data">
                        <div className="mb-4">
                            <label htmlFor="brandName" className="mb-2 text-left block text-sm font-medium text-gray-700">Brand Name <span className='text-red-500'>*</span></label>
                            <input
                                type="text"
                                id="brandName"
                                required
                        ...
                        <div className="mb-4 relative">
                            <label htmlFor="logo" className="block text-sm text-left font-medium text-gray-700">Logo <span className='text-red-500'>*</span></label>
